...
import comind.fr.redbullworks.utils.CustomReservationPager;
...
@EFragment(R.layout.fragment_reservations)
public class ReservationFragment extends Fragment implements TabLayout.OnTabSelectedListener {
    ...
    CustomReservationPager adapter;
    ...
    void initialize()
    {
        ...
        adapter = new CustomReservationPager(getActivity().getSupportFragmentManager());
